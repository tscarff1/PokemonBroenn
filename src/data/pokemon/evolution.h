const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 34, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_LEVEL, 34, SPECIES_GOURGEIST}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 33, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 33, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 33, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
