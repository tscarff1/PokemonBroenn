...
#define VAR_WISH_TAG_PROGRESS                0x4091 // //0 = Nothing, 1 = Wish Tag Purchased, 2 = Shelby talked to, 3 = Shelby defeated, 4 = JERRY met, 5 = fossil maniac talked to, 6 = Pure Bell Received, 7 = Rusturf Planned, 8 = Rusturf tunnel opened, 9 = JIRACHI battled
