...
#define VAR_WISH_TAG_PROGRESS                0x4091 // //0 = Nothing, 1 = Wish Tag Purchased, 2 = Shelby talked to, 3 = Shelby defeated, 4 = Ancient Coin obtained, 5 = Birch talked to, 6 = Rusturf tunnel opened, 7 = JIRACHI battled
